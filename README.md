...
1. Game selects a random number between 1 and 20
2. Click or tap grid cells to guess
3. Wrong guess: cell turns blue (too high) or orange (too low)
4. Score decreases by 1 for each wrong guess
5. Score reaches 1 and you guess wrong again = game over
6. Correct guess: cell turns green, badge reveals the number
